      ...
      <div className="relative flex-1 min-h-0">
        ...
        {mostrarBotonAbajo && (
          <button
            ...
            className="absolute bottom-4 right-4 flex h-9 w-9 items-center justify-center rounded-full bg-neutral-800 dark:bg-neutral-900 shadow-lg hover:bg-neutral-700 dark:hover:bg-neutral-800 transition-colors"
          >
